...
func (o *genConfigInitOptions) run(_ *cobra.Command, args []string) error {
...
func (o *genConfigInitOptions) generateYAMLContent(config ConfigData) string {
	...
	content.WriteString(fmt.Sprintf("# Generated by gzh-manager gen-config init\n"))
	content.WriteString(fmt.Sprintf("# Configuration for bulk Git repository management\n\n"))
