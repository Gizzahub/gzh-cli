...
> **🔗 Powered by**: [gzh-cli-gitforge](https://github.com/gizzahub/gzh-cli-gitforge) (for local Git operations)
>
> - **독립 설치**: `go install github.com/gizzahub/gzh-cli-gitforge/cmd/gzh-git@latest`
> - **상세 문서**: [gzh-cli-gitforge README](https://github.com/gizzahub/gzh-cli-gitforge#readme)
> - **통합 가이드**: [Subprojects Integration Guide](../integration/00-SUBPROJECTS_GUIDE.md#1-gzh-cli-gitforge)
...
```yaml
# (continued — repositories apply block)
