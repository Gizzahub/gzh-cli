...
과거 작업의 **기록물**입니다. 현재 상태를 설명하는 문서가 아니므로 참조 대상으로
삼지 마세요. 최신 정보는 [`docs/00-overview/`](../00-overview/)에서 시작합니다.

여기 있는 문서는 작성 시점의 스냅샷이며 이후 갱신되지 않습니다. 내용이 현재
코드와 어긋날 수 있습니다. 이력 추적 목적으로만 보존합니다.
...
`docs/` 최상위에 작업 보고서가 쌓여 문서 트리 탐색을 방해했습니다. 문서 규약
(`docs/80-reference/81-docs-conventions.md`, gzh-cli-devbox)의 90-99 슬롯
"기타/임시"에 맞춰 이곳으로 이동했습니다. 삭제가 아닌 이동이므로 정보 손실은
없습니다.
